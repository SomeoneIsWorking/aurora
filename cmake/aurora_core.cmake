...
if (AURORA_GPU_DIAGNOSTICS STREQUAL "standard")
    target_compile_definitions(aurora_core
        PUBLIC AURORA_GFX_DEBUG_GROUPS
        PRIVATE AURORA_GPU_DIAGNOSTICS_STANDARD)
elseif (AURORA_GPU_DIAGNOSTICS STREQUAL "full")
    target_compile_definitions(aurora_core
        PUBLIC AURORA_GFX_DEBUG_GROUPS
        PRIVATE AURORA_GPU_DIAGNOSTICS_FULL)
endif ()
